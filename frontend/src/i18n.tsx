...
const T: Record<Lang, Dict> = {
  ru: {
    ...
    nav: { library: "Библиотека", calendar: "Календарь" },
    pro: { badge: "PRO", title: "ShoulderReady Pro", subtitle: "Максимум пользы для атлета и тренера", f1: "AI-чат «Спроси реабилитолога» по вашим результатам", f2: "Полная библиотека упражнений с инструкциями", f3: "Календарь реабилитации и ретестов", f4: "Приоритетная поддержка и новые модули", cta: "Активировать Pro", active: "Pro активен", manage: "Управление Pro", deactivate: "Отключить Pro", lockedTitle: "Функция Pro", lockedText: "Откройте эту возможность в ShoulderReady Pro.", unlock: "Открыть в Pro", price: "Демо-режим · без оплаты" },
    chat: { title: "AI-реабилитолог", subtitle: "Консультация по результатам теста", placeholder: "Спросите об упражнениях, нагрузке, сроках…", empty: "Задайте вопрос по вашим результатам — я помогу с планом и упражнениями.", disclaimer: "AI-ассистент не заменяет очный осмотр врача.", thinking: "Печатает…" },
    library: { title: "Библиотека упражнений", subtitle: "Протоколы для сильного и стабильного плеча", target: "Цель", sets: "Подходы", howto: "Как выполнять", all: "Все", cat_rotator: "Ротаторная манжета", cat_scapular: "Лопатка", cat_mobility: "Мобильность", cat_stability: "Стабильность", cat_power: "Мощность" },
    calendar: { title: "Календарь реабилитации", subtitle: "Ближайшие ретесты и контрольные точки", upcoming: "Предстоящие", overdue: "Просрочено", noItems: "Нет запланированных ретестов. Пройдите оценку, чтобы получить дату.", daysLeft: "через {n} дн.", today: "сегодня", overdueBy: "просрочено на {n} дн.", retestFor: "Ретест RTS" },
  ...
  uk: {
    ...
    nav: { library: "Бібліотека", calendar: "Календар" },
    pro: { badge: "PRO", title: "ShoulderReady Pro", subtitle: "Максимум користі для атлета і тренера", f1: "AI-чат «Запитай реабілітолога» за вашими результатами", f2: "Повна бібліотека вправ з інструкціями", f3: "Календар реабілітації та ретестів", f4: "Пріоритетна підтримка та нові модулі", cta: "Активувати Pro", active: "Pro активний", manage: "Керування Pro", deactivate: "Вимкнути Pro", lockedTitle: "Функція Pro", lockedText: "Відкрийте цю можливість у ShoulderReady Pro.", unlock: "Відкрити в Pro", price: "Демо-режим · без оплати" },
    chat: { title: "AI-реабілітолог", subtitle: "Консультація за результатами тесту", placeholder: "Запитайте про вправи, навантаження, строки…", empty: "Поставте запитання за вашими результатами — я допоможу з планом і вправами.", disclaimer: "AI-асистент не замінює очний огляд лікаря.", thinking: "Друкує…" },
    library: { title: "Бібліотека вправ", subtitle: "Протоколи для сильного та стабільного плеча", target: "Ціль", sets: "Підходи", howto: "Як виконувати", all: "Усі", cat_rotator: "Ротаторна манжета", cat_scapular: "Лопатка", cat_mobility: "Мобільність", cat_stability: "Стабільність", cat_power: "Потужність" },
    calendar: { title: "Календар реабілітації", subtitle: "Найближчі ретести та контрольні точки", upcoming: "Майбутні", overdue: "Прострочено", noItems: "Немає запланованих ретестів. Пройдіть оцінку, щоб отримати дату.", daysLeft: "через {n} дн.", today: "сьогодні", overdueBy: "прострочено на {n} дн.", retestFor: "Ретест RTS" },
  ...
  en: {
    ...
    nav: { library: "Library", calendar: "Calendar" },
    pro: { badge: "PRO", title: "ShoulderReady Pro", subtitle: "Maximum value for athlete and coach", f1: "AI chat “Ask the rehab specialist” about your results", f2: "Full exercise library with instructions", f3: "Rehab & retest calendar", f4: "Priority support and new modules", cta: "Activate Pro", active: "Pro active", manage: "Manage Pro", deactivate: "Turn off Pro", lockedTitle: "Pro feature", lockedText: "Unlock this capability in ShoulderReady Pro.", unlock: "Unlock with Pro", price: "Demo mode · no payment" },
    chat: { title: "AI rehab coach", subtitle: "Consultation based on your test", placeholder: "Ask about exercises, loading, timelines…", empty: "Ask a question about your results — I'll help with the plan and exercises.", disclaimer: "The AI assistant does not replace an in-person medical exam.", thinking: "Typing…" },
    library: { title: "Exercise library", subtitle: "Protocols for a strong, stable shoulder", target: "Target", sets: "Sets", howto: "How to", all: "All", cat_rotator: "Rotator cuff", cat_scapular: "Scapula", cat_mobility: "Mobility", cat_stability: "Stability", cat_power: "Power" },
    calendar: { title: "Rehab calendar", subtitle: "Upcoming retests and checkpoints", upcoming: "Upcoming", overdue: "Overdue", noItems: "No retests scheduled. Run an assessment to get a date.", daysLeft: "in {n}d", today: "today", overdueBy: "overdue by {n}d", retestFor: "RTS retest" },
  ...
  he: {
    ...
    nav: { library: "ספרייה", calendar: "יומן" },
    pro: { badge: "PRO", title: "ShoulderReady Pro", subtitle: "מקסימום ערך לספורטאי ולמאמן", f1: "צ'אט AI «שאל את המשקם» לפי התוצאות שלך", f2: "ספריית תרגילים מלאה עם הוראות", f3: "יומן שיקום ובדיקות חוזרות", f4: "תמיכה בעדיפות ומודולים חדשים", cta: "הפעל Pro", active: "Pro פעיל", manage: "ניהול Pro", deactivate: "כבה Pro", lockedTitle: "פיצ'ר Pro", lockedText: "פתח יכולת זו ב-ShoulderReady Pro.", unlock: "פתח עם Pro", price: "מצב הדגמה · ללא תשלום" },
    chat: { title: "מאמן שיקום AI", subtitle: "ייעוץ לפי תוצאות הבדיקה", placeholder: "שאל על תרגילים, עומס, לוחות זמנים…", empty: "שאל שאלה על התוצאות שלך — אעזור עם התוכנית והתרגילים.", disclaimer: "עוזר ה-AI אינו מחליף בדיקה רפואית פנים אל פנים.", thinking: "מקליד…" },
    library: { title: "ספריית תרגילים", subtitle: "פרוטוקולים לכתף חזקה ויציבה", target: "מטרה", sets: "סטים", howto: "איך לבצע", all: "הכול", cat_rotator: "מסובב הכתף", cat_scapular: "שכמה", cat_mobility: "ניידות", cat_stability: "יציבות", cat_power: "עוצמה" },
    calendar: { title: "יומן שיקום", subtitle: "בדיקות חוזרות ונקודות ביקורת", upcoming: "קרובות", overdue: "באיחור", noItems: "אין בדיקות חוזרות מתוכננות. בצע הערכה כדי לקבל תאריך.", daysLeft: "בעוד {n} ימים", today: "היום", overdueBy: "באיחור של {n} ימים", retestFor: "בדיקת RTS חוזרת" },
